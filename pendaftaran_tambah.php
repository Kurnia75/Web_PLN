<?php 
 ...
 $i = mysql_fetch_array(mysql_query("SELECT * FROM login ORDER BY IdPelanggan DESC LIMIT 0,1"));

    $id_awal = substr($i['IdPelanggan'],3,4)+1;
    if ($id_awal < 10) {
        $id = '3000'.$id_awal;
    ...
    <div id="templatemo_middle" class="carousel">
      ...
      <?php if(($_SESSION['TypeUser']=='admin') || ($_SESSION['TypeUser']=='user')) { ?>
       ...
       <center>
                <div id="tambahubah">
           <div id="tambahubah">
            <p>Tambah Data Pendaftaran</p>
                <form name="tambahubah" method="post" action="pendaftaran_tambah_proses.php">
                        <div class="group-input" style="margin-bottom: 15px;">
                                            <label>Id Pelanggan :</label>
                                            <input type="text" name="IdPelanggan" class="form-control" readonly="" value="<?php echo $id; ?>">
                                        </div>
                        <input type="text" name="UserName" placeholder="Username" required oninvalid="this.setCustomValidity('tidak boleh kosong !')" oninput="setCustomValidity('')">
                        <input type="text" name="Password" placeholder="Password" required oninvalid="this.setCustomValidity('tidak boleh kosong !')" oninput="setCustomValidity('')">
                       <div class="group-input" style="margin-bottom: 15px;">
                    ...
                    <input type="text" name="Fullname" placeholder="Fullname" required oninvalid="this.setCustomValidity('tidak boleh kosong !')" oninput="setCustomValidity('')">
