<?php 
    ...
    $i = mysql_fetch_array(mysql_query("SELECT * FROM tbl_pelanggan ORDER BY id_Pelanggan DESC LIMIT 0,1"));

    $id_awal = substr($i['id_pelanggan'],3,4)+1;
    if ($id_awal < 10) {
        $id = '1000'.$id_awal;
        ...
        <center>
           ...
           <div id="tambahubah">
            <p>Tambah Data Pelanggan</p>
                <form name="tambahubah" method="post" action="pelanggan_tambah_proses.php">
                         <div class="group-input" style="margin-bottom: 15px;">
                                            <label>ID Pelanggan :</label>
                                            <input type="text" name="id_pelanggan" class="form-control" readonly="" value="<?php echo $id; ?>">
                                        </div>
                                        <div class="group-input" style="margin-bottom: 15px;">
