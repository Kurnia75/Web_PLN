        ...
        <table cellspacing="0">
                ...
                <tr>
                    ...
                    <th width="245">Fullname</th>
                        ...
                        <th width="100" colspan="1">Aksi</th>
                ...
                <?php 
                    ...
                    <tr>
                       ...
                       <td align="center"><a href="pendaftaran_hapus.php?IdPelanggan=<?php echo $data['IdPelanggan'];?>" onClick="return hapus()" style="color:#F00;"><img src="images/delete.png" width="15" height="15" title="Hapus"></a></td>
                        <td align="center"><a href="pendaftaran_hapus?IdPelanggan=<?php echo $data['IdPelanggan'];?>" onClick="return hapus()" style="color:#F00;"><img src="images/hapus.png" width="15" height="15" title="Hapus"></a></td>
