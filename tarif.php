  ...
  <?php if(($_SESSION['TypeUser']=='admin') || ($_SESSION['TypeUser']=='user')) { ?>
    ...
    <div id="templatemo_menu">
      ...
      <?php } ?>
        ...
        <div id="menu_second_bar">
        	...
        	<marquee direction="right" behavior="alternate" scrollamount="2" width="300" scrolldelay="20" style="float:left;"> Selamat Datang<strong> PLN Kurnia Juanugraha</strong>  </marquee>
    ...
    <div id="templatemo_middle" class="carousel">
        ...
        <div id="content" class="float_r">
        	<h1>PLN</h1>
          <p style="float:left; margin-bottom:0px; font-weight:bold;">Data Tarif</p>
        <?php if($_SESSION['TypeUser']=='admin') { ?>
        <a class="add" href="tarif_tambah.php" style="float:right;">Tambah Data</a>
        <?php } ?>
        <br style="clear:both;">
         <form method="post" action="tarif_hasil_pencarian.php" style="float: right;">
                                <select name="kategori" id="kategori" style="padding: 3.5px;" required="">
                                    ...
                                    <option value="daya">Daya Terpakai</option>
                ...
                <th>Beban</th>
                    ...
                    <?php } ?>
                                    ...
                                    <tbody>
                                        ...
                                        if ($jumlah == 0) {
                                            echo "<tr><td colspan=5>Tidak ada data dalam tabel ini !</td></tr>";
                                        }
                                        while ($data = mysql_fetch_assoc($query)) { ?>
                                            <tr>
                                                <td><?php echo $data['id_tarif'];?></td>
                                                <td><?php echo $data['kode'];?></td>
                                                <td><?php echo $data['daya']." wat";?></td>
                                                <td><?php if($data['tarif_perKWH'] == 3500){ echo "Rp. 3.500 (Daya : 480 wat)"; 
                                                        } else if ($data['tarif_perKWH'] == 5000) { echo "Rp. 5.000 (Daya : 900 wat)";
                                                        } else if ($data['tarif_perKWH'] == 6500) { echo "Rp. 6.500 (Daya : 1300 wat)";
                                                        }
                                                ;?></td>
                                                <td><?php echo "Rp. " . number_format($data['beban'], "0", ",", ".");?></td>
                        <?php if($_SESSION['TypeUser']=='admin') { ?>
                        <td align="center"><a href="tarif_ubah.php?id_tarif=<?php echo $data['id_tarif'];?>" style="color:#F90;"><img src="images/edit.png" width="15" height="15" title="Ubah"></a></td>
                        <td align="center"><a href="tarif_hapus.php?id_tarif=<?php echo $data['id_tarif'];?>" onClick="return hapus()" style="color:#F00;"><img src="images/delete.png" width="15" height="15" title="Hapus"></a></td>
                        <?php } ?> 
                    </tr>
                <?php } ?>
                </tbody>
