<?php 
    ...
    $i = mysql_fetch_array(mysql_query("SELECT * FROM tbl_pembayaran ORDER BY id_pembayaran DESC LIMIT 0,1"));

    $id_awal = substr($i['id_pembayaran'],3,4)+1;
    if ($id_awal < 10) {
        $id = '2000'.$id_awal;
...
<div id="templatemo_wrapper">
  ...
  <?php if(($_SESSION['TypeUser']=='admin') || ($_SESSION['TypeUser']=='user')) { ?>
    ...
    <div id="templatemo_middle" class="carousel">
     ...
     <center>
                <div id="tambahubah">
            <p>Tambah Data Pembayaran</p>
                <form name="tambahubah" method="post" action="pembayaran_tambah_proses.php">
                    <div class="group-input" style="margin-bottom: 15px;">
                                            <label>ID Pembayaran :</label>
                                            <input type="text" name="id_pembayaran" class="form-control" readonly="" value="<?php echo $id; ?>">
                                        </div>
                                        <div class="group-input" style="margin-bottom: 15px;">
                                        ...
                                        <div class="group-input" style="margin-bottom: 15px;">
                                            ...
                                            <input type="date" name="tanggal_bayar" placeholder="Tahun-Bulan-Tanggal" class="form-control" required="">
                                        </div>
                                        <div class="group-input" style="margin-bottom: 15px;">
                            ...
                            ?>
                                        ...
                                        <div class="group-input" style="margin-bottom: 15px;">
                                            ...
                                            <input type="text" name="biaya_denda" class="form-control" required="">
                                        </div>
                                        <div class="group-input" style="margin-bottom: 15px;">
