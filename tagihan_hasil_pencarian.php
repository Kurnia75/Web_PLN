...
<div id="templatemo_wrapper">
  ...
  <p style="float:left; margin-bottom:0px; font-weight:bold;">Data Tagihan</p>
        ...
        <?php } ?>
        <br style="clear:both;">
         <form method="post" action="tagihan_hasil_pencarian.php" style="float: right; color: #000;">
                                        <select name="kategori" id="kategori" style="padding: 3.5px;" required="">
                                            ...
                                            <option value="tagihan_bulanan">Tagihan Bulanan</option>
                                            <option value="tagihan_tahunan">Tagihan Tahunan</option>
                                            <option value="status_tagihan">Status Tagihan</option>
                                        </select>
                                    ...
                                    <tbody>
                                       <?php   
                                            if(isset($_POST['submit'])) {
                                                ...
                                                $query = mysql_query("SELECT * FROM tbl_tagihan WHERE $kategori LIKE '%$cari%'");
                                        ...
                                        while ($data = mysql_fetch_assoc($query)) { ?>
                                            <tr>
                                                ...
                                                <td><?php echo $data['tagihan_bulanan'];?></td>
                                                <td><?php echo $data['tagihan_tahunan'];?></td>
                                                <td><?php echo $data['status_tagihan'];?></td>
                        
                        <?php if($_SESSION['TypeUser']=='admin') { ?>
                        <td align="center"><a href="tagihan_ubah.php?id_tagihan=<?php echo $data['id_tagihan'];?>" style="color:#F90;"><img src="images/edit.png" width="15" height="15" title="Ubah"></a>
                        <td align="center"><a href="tagihan_hapus.php?id_tagihan=<?php echo $data['id_tagihan'];?>" onClick="return hapus()" style="color:#F00;"><img src="images/delete.png" width="15" height="15" title="Hapus"></a></td>
                        <?php } ?> 
                    </tr>
                <?php } ?>
                </tbody>
