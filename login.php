...
<div class="formlogin">
        ...
        <form name="login" method="POST" action="login_proses.php">
            <input type="text" name="UserName" placeholder="Username" required oninvalid="this.setCustomValidity('harus di isi !')" oninput="setCustomValidity('')">
            <input type="password" name="Password" placeholder="Password" required oninvalid="this.setCustomValidity('harus di isi !')" oninput="setCustomValidity('')">
            <input type="submit" value="Login">
        </form>
        </div></center>
		
		<!-- copy dimana hayangna -->
<?php if(($_SESSION['TypeUser']=='admin') || ($_SESSION['TypeUser']=='user')) { ?>
